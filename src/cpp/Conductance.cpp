...
double Conductance::getvonKarman() {return this-> vonKarman; }
double Conductance::getheightWeatherMeasurements() {return this-> heightWeatherMeasurements; }
double Conductance::getzm() {return this-> zm; }
double Conductance::getzh() {return this-> zh; }
double Conductance::getd() {return this-> d; }
void Conductance::setvonKarman(double _vonKarman) { this->vonKarman = _vonKarman; }
void Conductance::setheightWeatherMeasurements(double _heightWeatherMeasurements) { this->heightWeatherMeasurements = _heightWeatherMeasurements; }
void Conductance::setzm(double _zm) { this->zm = _zm; }
void Conductance::setzh(double _zh) { this->zh = _zh; }
void Conductance::setd(double _d) { this->d = _d; }
