...
Ptsoil::Ptsoil() { }
double Ptsoil::getAlpha() {return this-> Alpha; }
double Ptsoil::gettau() {return this-> tau; }
double Ptsoil::gettauAlpha() {return this-> tauAlpha; }
void Ptsoil::setAlpha(double _Alpha) { this->Alpha = _Alpha; }
void Ptsoil::settau(double _tau) { this->tau = _tau; }
void Ptsoil::settauAlpha(double _tauAlpha) { this->tauAlpha = _tauAlpha; }
