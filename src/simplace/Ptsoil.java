...
public class Ptsoil extends FWSimComponent
{
    ...
    protected void process()
    {
        ...
        double tenergyLimitedEvaporation;
        double AlphaE;
        if (ttau < ttauAlpha)
        {
            AlphaE = 1.0d;
    ...
    public HashMap<String, FWSimVariable<?>> createVariables()
    {
        ...
        addVariable(FWSimVariable.createSimVariable("revapoTranspirationPriestlyTaylor", "evapoTranspiration Priestly Taylor", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"http://www.wurvoc.org/vocabularies/om-1.8/", 0, 1000, 120, this));
